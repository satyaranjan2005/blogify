        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center p-12">
          <div className="text-center text-white">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Join thousands of writers sharing their stories and building their audience on Blogify.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Join Blogify</h1>
          </div>

          <div className="bg-white/70 backdrop-blur-md rounded-3xl shadow-xl border border-white/20 p-6">
            <div className="hidden lg:block text-center mb-6">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Create Account</h2>
              <p className="text-gray-600">Join our community of passionate writers.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-200 bg-white/50 backdrop-blur-sm"
