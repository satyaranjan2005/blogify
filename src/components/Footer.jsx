        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-lg mb-6 max-w-md">
              Discover amazing stories, connect with passionate writers, and share your own unique perspective with the world.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/create" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Write Article
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 Blogify. All rights reserved. Built with ❤️ using React & Node.js
            </div>
